...
public class Progression {
    ...
    public static void run() {
        ...
        for (int i = 0; i < Engine.ROUNDS; i++) {
            int progressionLength = Utils.getRandomNumber(MIX_PROGRESSION_LENGTH, MAX_PROGRESSION_LENGTH);
            int progressionStep = Utils.getRandomNumber(MIX_PROGRESSION_STEP, MAX_PROGRESSION_STEP);
